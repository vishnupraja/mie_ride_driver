...
const String _FONT_FAMILY = 'Bropames';
const String FONT_FAMILY = 'Nexa';

class FontsFamily {

  static TextStyle bropames =
  ...
  static TextStyle ExtraBolds =
  TextStyle(fontFamily: FONT_FAMILY, fontWeight: FontWeight.w500);
